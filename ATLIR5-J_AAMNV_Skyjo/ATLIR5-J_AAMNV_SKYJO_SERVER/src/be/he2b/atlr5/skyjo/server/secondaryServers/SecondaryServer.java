...
import be.he2b.atlr5.skyjo.business.AdminModel;
...
public class SecondaryServer {
    ...
    void SendPauseEverbody(Object object, SrvMsgType srvMsgType) {
        for(PlayerThread player : playerThreads){
            player.setNoObjectToSend(srvMsgType);
            player.sendToClient(object);
        }
    }
}
