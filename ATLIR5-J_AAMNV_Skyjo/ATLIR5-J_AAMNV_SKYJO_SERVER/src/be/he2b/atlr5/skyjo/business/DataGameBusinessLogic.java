...
import be.he2b.atlr5.skyjo.db.DataGameDB;
...
public class DataGameBusinessLogic {
     ...
     */
    static int add(DataGameDto dataGame) throws DBException, RepositoryException {
          var dbgame = new DataGameDB();
        return dbgame.insert(dataGame);
    }
