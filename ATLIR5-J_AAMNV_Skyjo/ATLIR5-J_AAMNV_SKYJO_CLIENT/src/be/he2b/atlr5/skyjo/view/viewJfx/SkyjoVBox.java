...
import be.he2b.atlr5.skyjo.skyjoPlayer.User;
...
public class SkyjoVBox extends VBox {
    ...
    Button pause;
    Button play;
  //  private EventHandler<MouseEvent> removePause;
    private EventHandler<MouseEvent> setPause;
    ...
    public SkyjoVBox(Facade game) {
        ...
        this.setPause = Event::consume;
       // this.removePause = Event::consume; 
    ...
    public void createVbox() {
        ...
        play = new Button();
        play.setText("play");
        super.getChildren().add(play);
        super.getChildren().add(pause);
    ...
    void freezeView() {
        ...
        this.addEventFilter(MouseEvent.ANY, this.setPause);
    }
    ...
    public void removeFreeze(){
        this.removeEventFilter(MouseEvent.ANY, this.setPause);
    }
}
