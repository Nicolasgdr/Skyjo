package be.he2b.atlr5.skyjo.view.viewJfx;

import be.he2b.atlr5.skyjo.view.viewJfx.fxmlControllers.UserMailInterface;
import be.he2b.atlr5.skyjo.view.viewJfx.fxmlControllers.UserInfo;
import be.he2b.atlr5.skyjo.view.viewJfx.fxmlControllers.AdminWaitingInterface;
import be.he2b.atlr5.skyjo.client.ClientConnexion;
import be.he2b.atlr5.skyjo.view.buttonHandlers.ButtonHandlers;
...
import static be.he2b.atlr5.skyjo.serverMsg.SrvMsgType.NEW_PLAYER;
import be.he2b.atlr5.skyjo.view.viewJfx.fxmlControllers.GameOverController;
...
public class SkyjoView implements Observer {
        ...
        switch (srvMsg.getType()) {
            ...
            case USER_CREATED -> {
             ...
             case pause_receive -> {
                 ...
                 if(client.isIsPause()){
                 this.hBox.freezeView();
                 }else{
                     this.hBox.freezeView();
                     this.vBox.freezeView();
                 }
                 
            }
             case play_receive-> {
                 System.out.println("avant freeze");
                 this.hBox.removeFreeze();
                 System.out.println("apres freeze");
                 this.vBox.removeFreeze();
             }
            case PLAYER_INFO ->
    ...
    public Button pause(){
        return this.vBox.getPause();
    }
    public Button play(){
        return this.vBox.getPlay();
    }
}
